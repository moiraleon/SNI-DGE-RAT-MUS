...
DESEQ2_RESULTS_FILE <- "final_matrix/deseq2_results_SNI_MUS_2_FEMALE_GSE123919_VS_GSE241361.csv"
DESEQ2_SUMMARY_FILE <- "final_matrix/deseq2_summary_SNI_MUS_2_FEMALE_GSE123919_VS_GSE241361.csv"
...
cat("Counts matrix loaded from:", COUNTS_FILE, "\n")
