...
OUTPUT_DIR <- "VIS_PCA_analysis/PostBatchEffectControl/GSE123919_VS_GSE241361"
...
cat("TPM matrix loaded from:", TPM_FILE, "\n")
...
write_csv(
  pca_df,
  file.path(OUTPUT_DIR, "PCA_from_TPM_batch_corrected_coordinates.csv")
)
...
ggsave(
  file.path(OUTPUT_DIR, "PCA_from_TPM_batch_corrected_by_GSE.png"),
  pca_plot_gse,
  width = 8,
  height = 6
)
...
ggsave(
  file.path(OUTPUT_DIR, "PCA_from_TPM_batch_corrected_by_condition.png"),
  pca_plot_condition,
  width = 8,
  height = 6
)
...
ggsave(
  file.path(OUTPUT_DIR, "PCA_from_TPM_batch_corrected_by_tissue.png"),
  pca_plot_tissue,
  width = 8,
  height = 6
)
