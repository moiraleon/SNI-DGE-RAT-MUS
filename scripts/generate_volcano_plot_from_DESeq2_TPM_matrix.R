...
OUTPUT_DIR <- "VIS_volcano_plot_analysis/PostBatchEffectControl/GSE123919_VS_GSE241361"
...
res <- read_csv(DESEQ2_RESULTS_FILE)

cat("DESeq2 results loaded from:", DESEQ2_RESULTS_FILE, "\n")
cat("Rows:", nrow(res), "\n")
